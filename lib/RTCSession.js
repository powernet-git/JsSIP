  ...
  _createLocalDescription(type, constraints)
  {
    ...
    return Promise.resolve()
      ...
      .then(() =>
      {
        ...
        const readyOnSelectedCandidatePair = constraints && constraints.readyOnSelectedCandidatePair && type === 'answer';
        const iceTransport = type === 'answer' ? connection.getSenders()[0].transport.iceTransport : null;
